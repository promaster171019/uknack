...
define(['angularAMD',
    ...
    function (angularAMD) {
        ...
        app.factory('user', ['$http', '$rootScope', '$resource', '$modal', 'restricted',
            function($http, $rootScope, $resource, $modal, restricted) {
                $rootScope.restricted();
                ...
                function connect(user_to_connect) {
                    if($rootScope.is_authenticated) {
                        ...
                        var modalInstance = $modal.open({
                            ...
                            resolve: {
                                message: function () {
                                    var message = 'You need to login to be able to connect with other classmates.';
                                    return message;
                                }
                            }
                        });
