...
define(['angularAMD'], function(app) {
        ...
        ['$scope', '$rootScope', '$resource', '$modalInstance', '$http', '$state', '$modal', 'knack', 'type',
            function ($scope, $rootScope, $resource, $modalInstance, $http, $state, $modal, knack, type) {
                ...
                $scope.getModalTitle = function() {
                    if($scope.type=='create' && $scope.knack.type=='O') {
                        return 'SELL YOUR KNACK';
                    }
                    if($scope.type=='create' && $scope.knack.type=='W') {
                        return 'WHAT DO YOU NEED DONE?';
                    }
                    if($scope.type=='edit') {
                        return 'EDIT YOUR KNACK ' + $scope.knack_type;
                    }
                    if($scope.type=='repost') {
                ...
                $scope.save_knack = function () {
                    ...
                    if ($scope.postForm.$valid) {
                        ...
                        if ($scope.type == 'create' || $scope.type=='repost') {
                            // Add new
    ...
    app.controller('ItemModalCtl',
        ['$scope', '$rootScope', '$resource', '$modalInstance', '$http', '$state', '$modal', '$stateParams', 'item', 'type',
            function ($scope, $rootScope, $resource, $modalInstance, $http, $state, $modal, $stateParams, item, type) {
                $scope.item = {
                    anonymous: false,
                    username: '',
                    name: '',
                ...
                $scope.getModalTitle = function() {
                    if($scope.type=='create' && $scope.item.type=='O') {
                        return 'SELL YOUR ITEM';
                    }
                    if($scope.type=='create' && $scope.item.type=='W') {
